...
class User{
	...
	public function userRegistation($data){
		...
		$chk_email = $this->emailChecek($email);
		...
		if(filter_var($email,FILTER_VALIDATE_EMAIL) === false){
			$msg = "<div class='alert alert-danger'><strong>Error ! </strong> Email address is not valied</div>";
			return $msg;			
		}
		
		if($chk_email == true){
			$msg = "<div class='alert alert-danger'><strong>Error ! </strong>The email allready exi</div>";
			return $msg;			
		}		
		
	}
	
	public function emailChecek($email){
